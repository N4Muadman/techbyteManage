                ...
                <div class="card pc-user-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0"><img src="{{ Auth::user()->employee?->avatar ? '/storage/' .Auth::user()->employee?->avatar :'/images/avatar.jpg' }}" alt="user-image"
            ...
            <div class="ms-auto">
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item header-user-profile"><a
                            ...
                            aria-expanded="false"><img src="{{ Auth::user()->employee?->avatar ? '/storage/' .Auth::user()->employee?->avatar :'/images/avatar.jpg' }}" alt="user-image"
                                class="user-avtar"></a>
                            ...
                            <div class="dropdown-body">
                                <div class="profile-notification-scroll position-relative"
                                    ...
                                    <div class="d-flex mb-1">
                                        <div class="flex-shrink-0"><img src="{{ Auth::user()->employee?->avatar ? '/storage/' .Auth::user()->employee?->avatar :'/images/avatar.jpg' }}"
