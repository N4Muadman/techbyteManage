...
Route::middleware('is_admin')->prefix('admin')->group(function (){
    Route::middleware('is_access')->prefix('quan-ly-nhan-vien')->group(function (){
    ...
    Route::middleware('is_access')->prefix('quan-ly-cham-cong')->group(function (){
    ...
    Route::middleware('is_access')->prefix('quan-ly-tien-luong')->group(function (){
    ...
    Route::middleware('is_access')->prefix('quan-ly-chi-nhanh')->group(function (){
    ...
    Route::middleware('is_access')->prefix('quan-ly-tuyen-dung')->group(function (){
    ...
    Route::middleware('is_access')->prefix('quan-ly-nghi-phep')->group(function (){
    ...
    Route::middleware('is_access')->prefix('danh-gia-khen-thuong')->group(function (){
    ...
    Route::middleware('is_access')->prefix('ho-tro-khieu-nai')->group(function (){
    ...
    Route::middleware('is_access')->prefix('quan-ly-ca-lam')->group(function (){
    ...
    Route::middleware('is_access')->prefix('khach-hang-tu-dau')->group(function (){
        ...
        Route::get('thong-ke', [Customer_manageController::class, 'statistics'])->name('customerStatistics');
    });

    Route::get('khach-hang-doanh-nghiep', [Customer_manageController::class, 'businessCustomer'])->middleware('is_access')->name('businessCustomer');
    Route::get('thong-ke-doanh-nghiep', [Customer_manageController::class, 'businessStatistics'])->middleware('is_access')->name('businessStatistics');
